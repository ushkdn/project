...
namespace project.Services.CharacterService
{
    public class CharacterService : ICharacterService
    {
        ...
        public async Task<ServiceResponse<List<GetCharacterDto>>> DeleteCharacter(int id)
        {
            ...
            try
            {
                var character = characters.FirstOrDefault(c => c.Id == c.Id);
                if (character is null)
                {
                    throw new Exception($"Characher with Id '{id}' not found.");
                }
        ...
        )
        {
            ...
            try
            {
                ...
                if (character is null)
                {
                    throw new Exception($"Characher with Id '{updatedCharacter.Id}' not found.");
                }
